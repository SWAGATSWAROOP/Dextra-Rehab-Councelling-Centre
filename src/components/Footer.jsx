      ...
      <div className="flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
        <div className="flex flex-col md:flex-row justify-between items-center w-full">
          ...
          <div className="flex flex-row md:flex-row md:space-y-0 md:space-x-10">
            <a href="#about" className="hover:underline pr-3">
              About
            </a>
            <a href="#services" className="hover:underline pr-3">
              Services
            </a>
            <a
            ...
            <a href="#contact" className="hover:underline pr-3">
              Contact
            </a>
          </div>
        </div>

        <div className="flex items-center justify-center bg-[#163172] md:pl-20">
